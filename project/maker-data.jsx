// maker-data.jsx — mock dataset + icon library
...
// Activity feed — completed swaps + recent maker events
const ACTIVITY = [
...
function truncTor(tor, head = 8, tail = 12) {
  if (!tor) return "";
...
Object.assign(window, {
  ICONS, MAKERS_BASE, ACTIVITY, fmtBtc, fmtSats, truncTor,
});
