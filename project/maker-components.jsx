// maker-components.jsx — Card pieces + atomic UI

const { useState, useEffect, useRef, useCallback } = React;

// ─── MetricCard ───────────────────────────────────────────────────────────────
function MetricCard({ variant, label, value, unit, sub, delta }) {
  return (
...
// ─── MakerCard ────────────────────────────────────────────────────────────────
function MakerCard({ maker, onManage }) {
  return (
...
Object.assign(window, {
  MetricCard, StatusDot, CopyButton, MakerCard, FilterTabs, ActivityCard, ActivityRow,
});
